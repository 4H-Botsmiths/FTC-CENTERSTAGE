...
@Autonomous(name = "Autonomous Blue", group = "A", preselectTeleOp = "Teleop")
public class AutonomousBlue extends OpMode {
  ...
  public void start() {
    ...
    try {
      ...
      Thread.sleep(1750); // How long it takes the robot to get to the center of the field
      ...
      Thread.sleep(4000); // How long it takes to hit the side of the field and straighten

      Drive(0, 0, 0); // Briefly stop robot
      Thread.sleep(500);

      Drive(0, -0.25, 0); // Controlled crash into the back of the field
      Thread.sleep(2500); // How long it takes to hit the back of the field and straighten
